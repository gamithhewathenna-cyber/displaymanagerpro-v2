...
<div class="flex min-h-screen">
  ...
  <aside id="app-sidebar" class="w-64 bg-white border-r border-gray-100 flex-shrink-0 fixed top-0 left-0 h-full z-40 flex flex-col transform -translate-x-full md:translate-x-0 transition-transform duration-200">
    ...
    <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
      ...
      <a href="/admin/customers" onclick="closeSidebar()" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors text-sm <?= str_starts_with($currentPath, '/admin') ? 'active' : '' ?>">
