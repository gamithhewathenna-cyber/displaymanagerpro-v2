...
<?php
  ...
  if ($_hiwBgRaw && !$_hiwBg) Settings::set('content_home_hiw_bg', '', 'content');
?>
<div class="bg-white rounded-2xl border border-gray-100 p-6 mt-6">
  <h2 class="font-semibold text-gray-900 mb-1 flex items-center gap-2">🎨 How It Works — Section Background Image</h2>
  <p class="text-xs text-gray-400 mb-5">Full-width background image behind the Simple Setup / How It Works steps. Recommended: <strong>1920 × 600 px</strong> · JPG, PNG or WebP · max 10 MB.</p>
