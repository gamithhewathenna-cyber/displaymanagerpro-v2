...
<form method="POST" action="/admin/content/refund/save" class="space-y-5" id="policy-form">
  <input type="hidden" name="_csrf_token" value="<?= Csrf::token() ?>">

  <div class="bg-white rounded-2xl border border-gray-100 p-6">
    <div class="flex items-center justify-between mb-4">
      <h2 class="font-semibold text-gray-900">Refund Policy</h2>
      <a href="/refund-policy" target="_blank" class="text-xs text-primary-600 hover:underline font-medium">View page →</a>
    </div>
  ...
  <div class="flex gap-3">
    <button type="submit" class="bg-primary-500 hover:bg-primary-600 text-white font-semibold px-6 py-2.5 rounded-xl text-sm transition-colors">Save Refund Policy</button>
    <a href="/refund-policy" target="_blank" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold px-6 py-2.5 rounded-xl text-sm transition-colors">Preview Page</a>
  </div>
</form>
