  ...
  <table class="w-full text-sm min-w-[480px]">
    <thead>
      <tr class="text-xs text-gray-400 bg-gray-50 border-b border-gray-100">
        ...
        <th class="px-4 py-3 text-left font-medium hidden md:table-cell">Updated</th>
    ...
    <tbody class="divide-y divide-gray-50">
      ...
      <tr class="hover:bg-gray-50/50">
        ...
        <td class="px-4 py-3 text-gray-400 text-xs hidden md:table-cell"><?= Helpers::timeAgo($t['updated_at']) ?></td>
