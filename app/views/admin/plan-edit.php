    ...
    <form method="POST" action="/admin/plans/<?= $plan['id'] ?>" class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="col-span-2"><label class="block text-sm font-medium text-gray-700 mb-1">Stripe Price ID (Annual)</label>
          <input type="text" name="stripe_price_id_annual" value="<?= Helpers::e($plan['stripe_price_id_annual']) ?>" placeholder="price_xxxxx" class="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-primary-500"></div>
