...
<body>
  <div>
    ...
    <div style="font-size:22px;font-weight:700;margin-bottom:10px"><?= Helpers::e($channel['name']) ?></div>
    <div style="font-size:14px;color:#6b7280">No slides added yet. Upload images in your dashboard.</div>
  </div>
</body>
</html>
