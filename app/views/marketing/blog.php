...
<section class="py-10 px-4 bg-gray-50 border-t border-gray-100">
  <div class="max-w-5xl mx-auto">
    <p class="text-center text-xs font-semibold text-gray-400 uppercase tracking-widest mb-5">Explore More</p>
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
      ...
      <a href="/faq" class="bg-white border border-gray-100 hover:border-primary-300 rounded-xl p-4 flex items-center gap-3 transition-all group hover:shadow-sm">
        <span class="text-xl flex-shrink-0">❓</span>
        <div><div class="text-sm font-semibold text-gray-800 group-hover:text-primary-600 transition-colors">FAQ</div><div class="text-xs text-gray-400">Common questions</div></div>
      </a>
    </div>
  </div>
</section>
