<section class="py-24 px-4">
  ...
  <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white border-2 <?= $i===1?'border-indigo-500 shadow-xl shadow-indigo-100':'border-gray-100' ?> rounded-2xl p-8 relative">
      ...
      <div class="text-4xl font-extrabold text-gray-900 mb-1">$<?= number_format($plan['price_monthly'],0) ?><span class="text-lg font-normal text-gray-400"> AUD/mo</span></div>
  ...
  <div class="mt-12 text-center text-sm text-gray-400">
    All prices in AUD. GST may apply. <a href="/contact" class="text-indigo-600 hover:text-indigo-700 font-medium">Need custom pricing?</a>
  </div>
</section>
