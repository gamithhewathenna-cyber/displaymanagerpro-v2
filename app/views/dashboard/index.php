...
<div class="bg-indigo-50 border border-indigo-200 rounded-xl p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:justify-between">
  ...
  <a href="/billing" class="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors self-start sm:flex-shrink-0">Activate Plan</a>
</div>
<?php elseif (!$isActive): ?>
<div class="bg-red-50 border border-red-200 rounded-xl p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:justify-between">
  <div class="flex items-center gap-3">
  ...
  <a href="/billing" class="bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors self-start sm:flex-shrink-0">Reactivate</a>
</div>
<?php endif; ?>
...
<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-8">
  <?php
    $stats = [
      ['Plan', Helpers::e($sub['plan_name'] ?? 'None'), 'Subscription', '#ec4899', 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2'],
