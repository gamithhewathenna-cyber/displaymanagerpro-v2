...
class AdminController extends BaseController
{
    ...
    public function settings(): void
    {
        ...
        $settings = [
            ...
            'payhere'     => Settings::getGroup('payhere'),
    ...
    public function saveSettings(): void
    {
        ...
        $allowed = [
            ...
            'payhere'     => ['payhere_mode','payhere_merchant_id','payhere_merchant_secret','payhere_app_id','payhere_app_secret','payhere_lkr_manual_rate'],
