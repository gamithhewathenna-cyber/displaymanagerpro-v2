    ...
    private function getDefaults(string $page): array
    {
        return match($page) {
            'home' => [
                ...
                'seo_description'     => '',
                'seo_keyphrase'       => '',
                'badge_text'          => 'Starter plan is 100% free · No credit card required',
                ...
                'step_1_desc'         => 'Sign up and choose your plan — Starter is free, forever.',
                ...
                'testimonial_2_quote' => '"DisplayNex has saved us hours every week. Updating specials and menu prices across multiple screens takes just minutes."',
                ...
                'testimonial_6_quote' => '"DisplayNex has streamlined our promotional displays and menu updates. The system works perfectly across all our locations."',
                ...
                'cta_subtitle'        => 'Get started free today. No credit card required. Cancel anytime.',
            ...
            'features' => [
                ...
                'cta_subtitle' => 'Free to start. No credit card required.',
            ...
            'industries' => [
                ...
                'hero_body'   => 'DisplayNex is a cloud-based digital signage platform that helps businesses manage TV screens, digital menu boards, promotional displays, and customer communications from anywhere. Whether you operate a restaurant in Sydney, a retail store in London, a salon in Auckland, or multiple business locations across the United States, DisplayNex gives you complete control over your content from one simple dashboard.',
                ...
                's1_body2'   => 'DisplayNex solves this problem by allowing businesses to centrally manage all screens from a secure cloud platform.',
                ...
                's1_footer'  => 'This makes DisplayNex ideal for franchises, hospitality groups, retail chains, healthcare providers, fitness centres, and corporate organisations.',
                ...
                's2_intro'   => 'Businesses use DisplayNex to:',
                ...
                's4_footer'   => 'No matter where your business operates, DisplayNex provides a simple and reliable way to manage your digital displays from anywhere.',
                'cta_title'  => 'Ready To Modernise Your Business Displays?',
                'cta_body1'  => 'Join businesses worldwide using DisplayNex to manage digital menu boards, promotions, announcements, and customer communications from one powerful cloud platform.',
                'cta_body2'  => 'Start free today and discover how easy it is to manage every screen from anywhere.',
                'cta_button' => 'Start Free Today →',
            ],
            'faq' => [
                'seo_title'       => '',
                ...
                'a1'  => 'No credit card required — the Starter plan is completely free.',
                ...
                'a10' => 'No — DisplayNex is cloud-based and requires an internet connection.',
            ...
            'contact' => [
                ...
                'cta_desc'    => 'Get started free. No credit card required.',
                'cta_button'  => 'Start Free Today →',
            ],
            'footer' => [
                ...
                'copyright'  => '© ' . date('Y') . ' DisplayNex. All rights reserved.',
            ],
            'pricing' => [
                'seo_title'       => '',
                'seo_description' => '',
            ...
            'about' => [
                ...
                'seo_description'   => '',
                'seo_keyphrase'     => '',
                'hero_subtitle'     => 'At DisplayNex, we help businesses update TV screens, digital menu boards, promotions, announcements, and in-store displays from one simple cloud-based dashboard.',
                's1_badge'          => 'Who We Help',
                's1_title'          => 'Built for businesses of all sizes',
                's1_body1'          => 'Whether you operate a restaurant, café, salon, retail store, clinic, hotel, showroom, or multi-location business, DisplayNex makes it easy to keep your content fresh, engaging, and up to date — without USB drives, printing costs, or manual screen updates.',
                ...
                's2_body2'          => 'DisplayNex eliminates these challenges with a powerful cloud digital signage platform. With just a few clicks, your content is automatically updated across all connected screens.',
                's2_stat_num'       => '$0',
                's2_stat_label'     => 'Starter plan, no card needed',
                ...
                's3_title'          => 'Why businesses choose DisplayNex',
                ...
                'vision_body3'      => 'As businesses continue to embrace digital transformation, DisplayNex is committed to providing an easy-to-use, reliable, and scalable platform that grows with your needs.',
                'cta_title'         => 'Start Free Today',
                'cta_body1'         => 'Experience the easiest way to manage digital signage, TV displays, digital menu boards, and promotional screens.',
                'cta_body2'         => 'Join businesses worldwide using DisplayNex to simplify screen management, improve customer engagement, and keep their content fresh.',
                'cta_button'        => 'Start Free Today →',
            ],
            'branding' => [],
            'privacy' => [
